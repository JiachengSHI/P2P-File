...
class Peer:
	def __init__(self, pid, neighbor):
		...
		server7 = server.Server(self.pid, self.neighbor)
		server7.start()
		#start pushupdate (details in pushupdate.py module)
		pushupdate7 = pushupdate.Pushupdate(self.pid, self.neighbor)
		pushupdate7.start()
		#start client (details in client.py module)
		client7 = client.Client(self.pid, self.neighbor)
		client7.start()
...
def main():
	...
	p7 = Peer(7, config.dict[topology]['p7'])
